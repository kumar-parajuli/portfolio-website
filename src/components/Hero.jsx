...
const Hero = () => {
  return (
    <section className="relative w-full mx-auto">
      <div
        className={`max-w-7xl mx-auto ${styles.paddingX} pt-20 sm:pt-24 pb-10 flex flex-row items-center justify-between gap-5`}
      >
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className={`${styles.heroHeadText} leading-tight`}
        >
